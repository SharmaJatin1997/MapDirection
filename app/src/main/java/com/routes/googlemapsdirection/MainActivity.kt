package com.routes.googlemapsdirection
...
class MainActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    var googleURL: StringBuilder? = null
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        getUrl(latLngOrigin.latitude, latLngOrigin.longitude, latLngDestination.latitude, latLngDestination.longitude)

        val urlDirections = googleURL.toString()
    ...
    private fun getUrl(
        ...
        googleURL = StringBuilder("https://maps.googleapis.com/maps/api/directions/json?")
        googleURL!!.append("origin=$latitide,$longitude")
        googleURL!!.append("&destination=$deLatitide,$deLongitude")
        googleURL!!.append("&key=" + "Please enter map key")
